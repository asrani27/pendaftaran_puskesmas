            ...
            <div class="card">
                <form method="post" action="/user/checkpasien">
                    ...
                    <div class="card-block text-center">
                        ...
                        <h4 class="m-t-20"> Pilih Asuransi
                        </h4>
                        <a href="/user/daftarpasien/puskesmas/{{$puskesmas}}/bpjs"
                            class="btn btn-primary btn-block btn-md btn-round">BPJS</a>
                        <a href="/user/daftarpasien/puskesmas/{{$puskesmas}}/umum"
                            class="btn btn-primary btn-block btn-md btn-round">UMUM</a>
